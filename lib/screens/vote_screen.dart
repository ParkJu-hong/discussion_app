...
class _VoteScreenState extends State<VoteScreen> {
  ...
  final Map<String, String> discussion = {
    'status': 'complete', // before_starting, in_progress, complete
  };
...
class OpinionCard extends StatefulWidget {
  final String user;
  ...
  @override
  _OpinionCardState createState() => _OpinionCardState();
}

class _OpinionCardState extends State<OpinionCard> {
  late bool? isAgree;
    ...
    return Column(
      children: [
        ...
        GestureDetector(
          ...
          child: Card(
            elevation: 3,
            shadowColor: widget.isItAgainst ? Colors.red : Colors.green,
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(16),
              side: BorderSide(
                color: widget.isItAgainst ? Colors.red : Colors.green,
              ),
            ),
            child: Container(
